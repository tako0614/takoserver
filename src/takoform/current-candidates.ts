...
/**
 * Exact build candidates for package/Definition byte matching and provider
 * capability composition. This corpus is unsigned and confers no install,
 * support, activation, publisher, or revocation authority at runtime.
 */
