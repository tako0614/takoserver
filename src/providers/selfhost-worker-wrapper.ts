...
} from "./edge-vector-worker-facade-source.ts";
import {
...
export const SELFHOST_WORKER_EDGE_VECTOR_BINDING_KIND = EDGE_VECTOR_WORKER_FACADE_KIND;
/**
          ...
          : descriptor.kind === ${JSON.stringify(SELFHOST_WORKER_EDGE_QUEUE_BINDING_KIND)}
            ...
            : descriptor.kind === VECTOR_KIND
              ? createEdgeVectorAdapter((operation, input, project) => {
                  ...
                  return call(VECTOR_URL, payload, VECTOR_ERROR_CODES, project);
                })
