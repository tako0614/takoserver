 ...
 *
 * The literal staging Host API v1 candidate lane is the only Host API described
 * here.
...
const PUBLIC_PATHS: Record<string, Record<string, unknown>> = {
  ...
  "/.well-known/takoform/v1": operation("get", "Staging Host API v1 candidate discovery", {
    security: [],
  }),
