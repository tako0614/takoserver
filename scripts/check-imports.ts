...
const LAYERS: readonly Layer[] = [
  ...
  },
  {
    name: "core",
    match:
      /^src\/(?:ports|json|strict-json|form-ref|interface-ref|provider-port|ai-port|s3-port|s3-issuer-router|db-schema|migrate-sqlite)\.ts$/u,
    may: ["core"],
  },
  {
    name: "adapter",
  ...
  },
  {
    ...
    match:
      /^src\/(?:app|deployment-composition|hosted-object-bucket-supplies|object-bucket-deployment|payment-setup|worker-data-services|worker-object-bucket-composition)\.ts$/u,
