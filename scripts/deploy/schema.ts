...
> = {
  ...
  "0050_workflow_instances.sql":
    "sha256:df882d84764e23fb439261c9454485f23dbeed53fe922020da238b104ff5c3de",
  "0051_workflow_execution.sql":
    "sha256:289e747c1bd84eaef858b243739bc669736ea5c8dcca6871a0084ec19f50b968",
  "0052_workflow_termination_intent.sql":
    "sha256:f55d8f6a40b8ed539294517445f0472857f01a7ad2a958599a5b4a4e17cecb06",
  "0053_queue_custody.sql":
...
> = {
  ...
  "0050": {
    fromCount: 49,
    fromMigration: "0049_artifact_consumer_active_resolution.sql",
    throughCount: 50,
    throughMigration: "0050_workflow_instances.sql",
  },
  "0051": {
    fromCount: 50,
    fromMigration: "0050_workflow_instances.sql",
    throughCount: 51,
    throughMigration: "0051_workflow_execution.sql",
  },
  "0052": {
    fromCount: 51,
    fromMigration: "0051_workflow_execution.sql",
    throughCount: 52,
    throughMigration: "0052_workflow_termination_intent.sql",
  },
  "0053": {
    fromCount: 52,
    fromMigration: "0052_workflow_termination_intent.sql",
    throughCount: 53,
    throughMigration: "0053_queue_custody.sql",
  },
  "0054": {
    fromCount: 53,
  ...
  "0056": {
    fromCount: 55,
    fromMigration: "0055_queue_custody_transfer_notices.sql",
    throughCount: 56,
    throughMigration: "0056_vector_index_storage.sql",
  },
};
...
function selectSchemaWave(
  ...
  if (JSON.stringify(artifact.names) !== JSON.stringify(AUDITED_MIGRATION_LINEAGE)) {
    throw preflightError(
      "selected D1 wave requires the exact audited source inventory 0001-0056",
...
/**
 * Reads the current audited 0001-0056 migration corpus without changing the ordinary
...
export function readAuditedMigrationArtifact(
  ...
  if (JSON.stringify(artifact.names) !== JSON.stringify(AUDITED_MIGRATION_LINEAGE)) {
    throw preflightError(
      "audited migration lineage must contain exactly 0001-0056",
