    ...
    },
    {
      ...
      obligations: {
        ...
        "failure-handling":
          ...
          "R2 name, audited 0001-0058 lineage and canonical migrated schema. Production and rehearsal " +
    ...
    },
    {
      ...
      obligations: {
        provenance:
          ...
          "the fixed audited 0001-0058 names and bytes are sealed before creation. A separately " +
        ...
        "post-conditions":
          ...
          "0001-0058 lineage and canonical schema after one Wrangler file import, then creates and reads back one new R2 bucket. " +
    ...
    },
    {
      ...
      obligations: {
        provenance:
          ...
          "forward-only apply. The current source inventory is exactly 0001-0058; unreviewed 0059+ tails are refused before any provider command. Protected wave selectors still end at 0057. " +
