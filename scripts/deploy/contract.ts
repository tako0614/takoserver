  ...
  surfaces: [
    {
      ...
      obligations: {
        ...
        "post-conditions":
          ...
          "contiguous 0044-0053 tail, is pending, public smoke instead requires the " +
        ...
        "failure-handling":
          ...
          "followed only by an accepted contiguous 0044-0053 tail, while the selected target is the all-traffic " +
    ...
    },
    {
      ...
      obligations: {
        ...
        "post-conditions":
          ...
          "pending lineage through 0043, followed only by an accepted contiguous 0044-0053 tail, is pending, " +
        ...
        "failure-handling":
          ...
          "followed only by an accepted contiguous 0044-0053 tail, while " +
    ...
    },
    {
      ...
      obligations: {
        provenance:
          ...
          "the fixed audited 0001-0053 names and bytes are sealed before creation. A separately " +
        ...
        "post-conditions":
          ...
          "0001-0053 lineage and canonical schema after one Wrangler file import, then creates and reads back one new R2 bucket. " +
    ...
    },
    {
      ...
      obligations: {
        provenance:
          ...
          "0033, 0036, 0043, 0044, 0045, 0046, 0047, 0048, 0049, 0050, 0051, 0052 or 0053. The exact predecessor lineage, selected through-prefix and wave " +
          "bytes are checked against their fixed SHA-256 inventory, digested and sealed before the " +
          "forward-only apply. The current source inventory is exactly 0001-0053; unreviewed 0054+ tails are refused before any provider command. " +
