...
try {
  ...
  if (
    ...
    JSON.stringify([
      ...
      "tf_deferred_operations_selection_v1",
      "tf_operation_commit_guards",
      "tf_provider_mutation_sagas",
      "tf_provider_mutation_sagas_selection_v1",
