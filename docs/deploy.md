...
audited 0001–0060 lineage and verifies its canonical schema, then creates the
...
D1 UUID-to-name mapping, R2 existence, exact audited 0001–0060 migration lineage,
...
- `takoserver-d1-schema`: ordered, forward-only D1 migration waves. Status,
  ...
  0001–0060 names and SHA-256 inventory, so a checkout with unreviewed 0061+
...
The current source includes audited 0058–0060 for fresh, explicitly
...
`--through-migration=0059`, or `--through-migration=0060`.
